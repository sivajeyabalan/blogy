...
import { Paper, Typography, CircularProgress, Divider, Grid, Card, CardContent, CardMedia } from '@mui/material';
                    ...
                    <Grid container spacing={3}>
                        {recommendedPosts.map(({ title, name, message, likes, selectedFile, _id }) => (
                            <Grid item xs={12} sm={6} md={4} key={_id}>
                                <Card className={classes.recommendedPostCard} onClick={() => openPost(_id)}>
                                    <CardMedia
