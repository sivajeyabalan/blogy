...
import {
    Container, Grow, Grid, Paper, AppBar, TextField, Button, Autocomplete
} from "@mui/material";
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <AppBar className={classes.appBarSearch} position="static" color="inherit">
                            ...
                            <Autocomplete
                                ...
                                style={{ margin: "10px 0" }}
                            />
                            <Button onClick={searchPost} className={classes.searchButton} variant="contained" color="primary" >Search</Button>                        </AppBar>
